...
public class WithdrawalService {
  ...
  public String withdraw(Long accountId, BigDecimal amount) {
        ...
        try {
            ...
            int rowsAffected = accountRepository.withdrawFromAccount(accountId, amount);

            if (rowsAffected == 0) {
                log.info("Insufficient funds for accountId={}, amount={}", accountId, amount);
                return "Insufficient funds for withdrawal";
            }
        } catch (Exception e) {
            log.info("Withdrawal failed for accountId={}, amount={}", accountId, amount);
